    ...
    <section class="content">
        <div class="box box-default">
            <div class="box-header with-border text-center">
                <h1 class="box-title">Department Trash Lists</h1>
            </div>
            ...
            <div class="box-body">
                ...
                <div>
                    <ul class="nav nav-tabs">
                        ...
                        ?>
                        <li role="presentation"><a href="view_department.php">Running Departments</a></li>
                    ...
                    <table id="table_info" class="table table-striped table-bordered">
                        ...
                        foreach (Department::getAll_trashDepartment() as $key => $value){
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-default" onclick="return confirm('Are u sure to mve?')"
                                       href="?trashId=<?php echo $value["id"]; ?>">Undo</a></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
